...
import com.myapp.myvideoapplication.domain.Post;
import com.myapp.myvideoapplication.repository.PostRepository;
...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().title(DEFAULT_TITLE).content(DEFAULT_CONTENT).file(DEFAULT_FILE).fileContentType(DEFAULT_FILE_CONTENT_TYPE);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().title(UPDATED_TITLE).content(UPDATED_CONTENT).file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE);
        return post;
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.title(UPDATED_TITLE).content(UPDATED_CONTENT).file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).content(UPDATED_CONTENT).file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE);
