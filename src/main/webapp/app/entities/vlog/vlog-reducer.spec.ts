...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vlog.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VLOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_VLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VLOG actions', async () => {
      const expectedActions = [
        {
